function Invoke-Obfuscated {
    ...
    function g7 {
        [xml]$l1 = (Invoke-WebRequest -Uri ([string]::Join('',('h','t','t','p','s',':','/','/','w','w','w','.','i','a','n','a','.','o','r','g','/','a','s','s','i','g','n','m','e','n','t','s','/','s','e','r','v','i','c','e','-','n','a','m','e','s','-','p','o','r','t','-','n','u','m','b','e','r','s','/','s','e','r','v','i','c','e','-','n','a','m','e','s','-','p','o','r','t','-','n','u','m','b','e','r','s','.','x','m','l'))) .Content
        $o2 = ""
        ...
        foreach ($r5 in $l1.ChildNodes.record){
            ...
            Write-Progress -Activity ("P"+"r"+"o"+"c"+"e"+"s"+"s"+"i"+"n"+"g"+" "+"r"+"e"+"c"+"o"+"r"+"d"+"s") -Status ("G"+"e"+"t"+"t"+"i"+"n"+"g"+" "+"p"+"o"+"r"+"t"+" "+"d"+"e"+"s"+"c"+"r"+"i"+"p"+"t"+"i"+"o"+"n"+"s"+" "+"f"+"r"+"o"+"m"+" "+"t"+"h"+"e"+" "+"w"+"e"+"b"+" "+$p6+"%") -PercentComplete $p6
        ...
        Write-Progress -Activity ("P"+"r"+"o"+"c"+"e"+"s"+"s"+"i"+"n"+"g"+" "+"r"+"e"+"c"+"o"+"r"+"d"+"s") -Status ("G"+"e"+"t"+"t"+"i"+"n"+"g"+" "+"p"+"o"+"r"+"t"+" "+"d"+"e"+"s"+"c"+"r"+"i"+"p"+"t"+"i"+"o"+"n"+"s"+" "+"f"+"r"+"o"+"m"+" "+"t"+"h"+"e"+" "+"w"+"e"+"b"+" "+$p6+"%") -Completed
    ...
    function v9 {
        ...
        $rD = ([string]::Join('',('h','t','t','p','s',':','/','/','r','a','w','.','g','i','t','h','u','b','u','s','e','r','c','o','n','t','e','n','t','.','c','o','m','/','t','e','k','s','h','t','e','i','n','t','/','P','m','a','p','/','m','a','i','n','/','p','m','a','p','.','p','s','d','1')))
        ...
        if ($lF.Major -lt $rI.Major) {
            Write-Host ("A"+" "+"n"+"e"+"w"+" "+"v"+"e"+"r"+"s"+"i"+"o"+"n"+" "+"("+$rI+")"+" "+"i"+"s"+" "+"a"+"v"+"a"+"i"+"l"+"a"+"b"+"l"+"e"+"."+" "+"P"+"l"+"e"+"a"+"s"+"e"+" "+"u"+"p"+"d"+"a"+"t"+"e"+" "+"y"+"o"+"u"+"r"+" "+"m"+"o"+"d"+"u"+"l"+"e"+".") -ForegroundColor Yellow
        }
    }
    # endregion
